...
import 'package:maligali/BusinessLogic/utils/dropdownLists/groceryDropdowns.dart';
...
import '../../../../../BusinessLogic/utils/dropdownLists/cleaningDropDownItems.dart';
import '../../../../../BusinessLogic/utils/dropdownLists/roastersDropDownItems.dart';
import '../../../../../BusinessLogic/utils/dropdownLists/stationaryDropDownItems.dart';
...
import 'components/photo_capture_container_widget.dart';
...
11- productPhoto
 */
class AddCustomProductToUserInventoryScreen extends StatefulWidget {
  //attributes and constructors
  static String routeName =
      "/CreateNewCustomProductScreen"; //screen route name for navigator
  AddCustomProductToUserInventoryScreen({Key? key}) : super(key: key);

  @override
  State<AddCustomProductToUserInventoryScreen> createState() => _AddCustomProductToUserInventoryScreenState();
}

class _AddCustomProductToUserInventoryScreenState extends State<AddCustomProductToUserInventoryScreen> {
  final _formKey = GlobalKey<
      FormState>();
 //key for the form that displays and edits product information
  late ItemCountField incDecNoOfCartons =
      ItemCountField();
 //Widget that adds a number of cartons to the users inventory
  late ItemCountField incDecNoOfSingleProduct =
      ItemCountField();
 //Widget that adds a number of packs to the users inventory
  ...
  DropdownBox invSectionsDropdownBox = DropdownBox(
    title: "اسم القسم",
    options: grocerySectionNameList,
    titleImageUrl: "assets/images/food-stand.png",
  );

  // DropdownBox productPurchaseUnitDropdownBox = DropdownBox(
  //   title: "وحدة الشراء",
  //   options: groceryPurchaseUnitList,
  //   titleImageUrl: "assets/images/stack_inventory.png",
  // );
  //
  // DropdownBox productSaleUnitDropdownBox = DropdownBox(
  //   title: "وحدة البيع",
  //   options: grocerySaleUnitList,
  //   titleImageUrl: "assets/images/sale_unit1.png",
  // );

  getDropDownBoxes(){
    String shopType = StoreOwner.storeType;
    if(shopType == "cleaning"){
      invSectionsDropdownBox = DropdownBox(
        title: "اسم القسم",
        options: cleaningSectionNameList,
        titleImageUrl: "assets/images/food-stand.png",
      );

      // productPurchaseUnitDropdownBox = DropdownBox(
      //   title: "وحدة الشراء",
      //   options: cleaningPurchaseUnitList,
      //   titleImageUrl: "assets/images/stack_inventory.png",
      // );

      // productSaleUnitDropdownBox = DropdownBox(
      //   title: "وحدة البيع",
      //   options: cleaningSaleUnitList,
      //   titleImageUrl: "assets/images/sale_unit1.png",
      // );
    }
      ...
      invSectionsDropdownBox = DropdownBox(
        title: "اسم القسم",
        options: roastersSectionNameList,
        titleImageUrl: "assets/images/food-stand.png",
      );

      // productPurchaseUnitDropdownBox = DropdownBox(
      //   title: "وحدة الشراء",
      //   options: roastersPurchaseUnitList,
      //   titleImageUrl: "assets/images/stack_inventory.png",
      // );
      // productSaleUnitDropdownBox = DropdownBox(
      //   title: "وحدة البيع",
      //   options: roastersSaleUnitList,
      //   titleImageUrl: "assets/images/sale_unit1.png",
      // );
    }
      ...
      invSectionsDropdownBox = DropdownBox(
        title: "اسم القسم",
        options: stationarySectionNameList,
        titleImageUrl: "assets/images/food-stand.png",
      );

      // productPurchaseUnitDropdownBox = DropdownBox(
      //   title: "وحدة الشراء",
      //   options: stationaryPurchaseUnitList,
      //   titleImageUrl: "assets/images/stack_inventory.png",
      // );
      //
      // productSaleUnitDropdownBox = DropdownBox(
      //   title: "وحدة البيع",
      //   options: stationarySaleUnitList,
      //   titleImageUrl: "assets/images/sale_unit1.png",
      // );
    }
  }
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child:
                      productInformationColumn(), //upper part of the screen that allows user to enter all new product information and a photo
                ),
                //////////////////////////////////
                Text(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //   child: productPurchaseUnitDropdownBox,
                  // ),
                  // Padding(
                  //   padding: const EdgeInsets.only(top: 15).r,
                  //   child: productSaleUnitDropdownBox,
                  // ),
                  Padding(
                    padding: const EdgeInsets.only(top: 15).r,
                    child: invSectionsDropdownBox,
                  ),
          ...
          if (_formKey.currentState!.validate()) {
            ...
            if (barcodeCont.text == "") {
              ...
              barcodeCont.text = addToInvVM
                  .generateBarCodeFromDropDown(sectionCont.text, StoreOwner.storeType); //generate barcode
            }
